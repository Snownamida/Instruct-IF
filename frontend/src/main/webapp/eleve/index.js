    ...
    .done(function (response) {
      ...
      response.forEach(function (demande) {
        const row =
          ...
          "</td>" +
          "<td>" +
          demande.intervenantDto.nom +
          " " +
          demande.intervenantDto.prenom +
          "</td>" +
          "<td>" +
    ...
    .done(function (response) {
      if (response !== null) {
        ...
        $("#TeacherFullName").text(
          response.intervenantDto.prenom + " " + response.intervenantDto.nom
        );
      } else {
...
function checkFormFields() {
  ...
  $("#submitRequestButton").prop(
    "disabled",
    !(matiereSelected && descriptionFilled)
  );
}
